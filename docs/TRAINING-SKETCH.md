...
| Rate | FP32 bpp hinge, or STE + `quantized_rate_stats` via `--ste-quant` | Learned entropy model (ANS / bits-back) — see [ENTROPY-CODING-NOTES.md](./ENTROPY-CODING-NOTES.md) |
...
- Learned entropy coding (STE uniform quant landed; factorized / ANS model still later)
